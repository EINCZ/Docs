...
All documentation, governance settings and security artifacts are stored in: /docs/security/

Everything is publicly auditable through Avalanche explorers.

---

## 8. Contribution Guidelines

Developers can contribute improvements to:
...
Protocol-level modifications must go through governance.
